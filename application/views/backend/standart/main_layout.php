	...
	<div class="wrapper" id="app">
	  ...
	  ?>
			...
			<a href="<?= site_url('/'); ?>" class="logo">
				<span class="logo-mini"><b><img src="<?= BASE_ASSET ?>img/Logo-Kota-Semarang.png"
							height="40px"></b></span>
				<span class="logo-lg"><b><img src="<?= BASE_ASSET ?>img/Logo-Kota-Semarang.png"
							height="40px"></b></span>
			</a>
					...
					?>
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<span
									class="hidden-xs"><?= _ent(ucwords(clean_snake_case(get_user_data('full_name')))); ?></span>
							</a>
							<ul class="dropdown-menu">
								<li class="user-header">
									...
									<p>
										...
										<small>Last Login,
											<?= date('Y-M-D', strtotime(get_user_data('last_login'))); ?></small>
									</p>
								</li>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2017-<?= date('Y'); ?> <a href="#"><?= get_option('site_name'); ?></a>.</strong>
			All rights
			reserved.
		</footer>
