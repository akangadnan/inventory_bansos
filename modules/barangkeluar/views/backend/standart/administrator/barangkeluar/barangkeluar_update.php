...
<section class="content-header">
	<h1>
		Barangkeluar        <small>Edit Barangkeluar</small>
	</h1>
	<ol class="breadcrumb">
				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group group-tujuan">
								...
								<div class="col-sm-8">
									<select class="form-control chosen chosen-select-deselect" name="tujuan_posko" id="tujuan_posko" data-placeholder="Select Penerima">
										<option value=""></option>
										<?php
										$conditions = [
											];
										...
										<option <?= $row->posko_id == $barangkeluar->tujuan_posko ? 'selected' : ''; ?> value="<?= $row->posko_id ?>"><?= $row->posko_nama; ?></option>
										<?php endforeach; ?>
									</select>
						...
						<div class="form-group group-tujuan">
								...
								<div class="col-sm-8">
									<select class="form-control chosen chosen-select-deselect" name="tujuan" id="tujuan" data-placeholder="Select Penerima">
										<option value=""></option>
										<?php
										$conditions = [
											];
										...
										<option <?= $row->id_sumber == $barangkeluar->tujuan ? 'selected' : ''; ?> value="<?= $row->id_sumber ?>"><?= $row->nama_sumber; ?></option>
										<?php endforeach; ?>
									</select>
									<small class="info help-block">
										</small>
						...
						<div class="form-group group-jumlah  ">
								...
								<div class="col-sm-8">
									<input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="" value="<?= set_value('jumlah', $barangkeluar->jumlah); ?>">
									<small class="info help-block">
						...
						<div class="form-group group-keterangan  ">
								...
								<div class="col-sm-8">
									<textarea placeholder="Keterangan" id="keterangan" name="keterangan" rows="5" class="textarea form-control"><?= set_value('keterangan', $barangkeluar->keterangan); ?></textarea>
									<small class="info help-block">
										</small>
								</div>
							</div>
						...
						<div class="form-group group-tanggal  ">
								...
								<div class="col-sm-6">
									<div class="input-group date col-sm-8">
										<input type="text" class="form-control pull-right datepicker" name="tanggal" placeholder="" id="tanggal" value="<?= set_value('barangkeluar_tanggal_name', $barangkeluar->tanggal); ?>">
									</div>
									<small class="info help-block">
										</small>
								</div>
						...
						<div class="form-group group-waktu  ">
								...
								<div class="col-sm-6">
									<div class="input-group date col-sm-8">
										<input type="text" class="form-control pull-right timepicker" name="waktu" id="waktu" value="<?= set_value('barangkeluar_waktu_name', $barangkeluar->waktu); ?>">
									</div>
									<small class="info help-block">
										</small>
								</div>
