	                ...
	                <div class="box-body ">
						...
						?>
	                        <div class="form-group group-asal-posko ">
	                            <label for="asal" class="col-sm-2 control-label">Asal Posko<i
	                                    class="required">*</i></label>
	                            <div class="col-sm-8">
	                                <select class="form-control chosen chosen-select-deselect" name="asal_posko"
	                                    id="asal_posko" data-placeholder="Select Asal">
	                                    <option value=""></option>
	                                    <?php
										$conditions = [
											];
	                        ...
	                        <div class="form-group group-asal ">
	                            ...
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" name="nama_donatur" id="nama_donatur"
	                                    placeholder="Nama Donatur" value="<?= set_value('nama_donatur'); ?>">
	                            </div>
	                        </div>
	                        <div class="form-group group-asal ">
	                            ...
	                            <div class="col-sm-8">
	                                <input type="text" class="form-control" name="jumlah" id="jumlah"
	                                    placeholder="Alamat Donatur" value="<?= set_value('jumlah'); ?>">
	                            </div>
	                        </div>
	                        <div class="form-group group-asal ">
	                            ...
	                            <div class="col-sm-8">
	                                <input type="number" class="form-control" name="phone_donatur" id="phone_donatur"
	                                    placeholder="No telepon Donatur" value="<?= set_value('phone_donatur'); ?>">
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group group-keterangan ">
	                            ...
	                            <div class="col-sm-8">
	                                <textarea id="keterangan" name="keterangan" rows="5" class="textarea form-control"
        ...
        return $.ajax({
            ...
            .done(function(res) {
                ...
                $.each(res, function(index, val) {
                    html += '<option value="' + val.id_barang + '">' + val.nama_barang + ' (' + val
                        .stok + ' ' + val.nama_satuan + ')' + '</option>'
                });
