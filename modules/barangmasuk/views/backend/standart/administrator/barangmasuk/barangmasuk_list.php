								...
								<table class="table table-bordered table-striped dataTable">
									...
									<tbody id="tbody_barangmasuk">
										...
										<tr>
											...
											<td><span
													class="list_group-jumlah"><?= _ent($barangmasuk->jumlah).' '._ent($barangmasuk->nama_satuan); ?></span>
											</td>
											<td><span
													class="list_group-keterangan"><?= _ent($barangmasuk->keterangan); ?></span>
											</td>
											<td width="200">

												<?php is_allowed('barangmasuk_view', function() use ($barangmasuk){?>
												<a href="<?= site_url('administrator/barangmasuk/view/' . $barangmasuk->id_barangmasuk); ?>"
													...
													<a href="<?= site_url('administrator/barangmasuk/edit/' . $barangmasuk->id_barangmasuk); ?>" class="label-default"><i class="fa fa-edit "></i>
														<?= cclang('update_button'); ?></a>
													<?php }) ?>
													<?php is_allowed('barangmasuk_delete', function() use ($barangmasuk){?>
													<a href="javascript:void(0);"
														data-href="<?= site_url('administrator/barangmasuk/delete/' . $barangmasuk->id_barangmasuk); ?>"
