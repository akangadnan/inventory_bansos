				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group group-jenis_layanan_nama  ">
							<label for="jenis_layanan_nama" class="col-sm-2 control-label">Nama Layanan <i
									class="required">*</i>
							</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="jenis_layanan_nama"
									id="jenis_layanan_nama" placeholder=""
									value="<?= set_value('jenis_layanan_nama', $jenis_layanan->jenis_layanan_nama); ?>">
