			...
			<div class="box box-primary">
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<?= form_open(base_url('administrator/kecamatan/edit_save/'.$this->uri->segment(4)), [
							'name' => 'form_kecamatan',
	...
	$(document).ready(function () {
		...
		$('#btn_cancel').click(function () {
			swal({
				...
				function (isConfirm) {
					if (isConfirm) {
						window.location.href = BASE_URL + 'administrator/kecamatan';
					}
				});
		...
		$('.btn_save').click(function () {
			...
			var form_kecamatan = $('#form_kecamatan');
			var data_post = form_kecamatan.serializeArray();
			...
			$.ajax({
					url: form_kecamatan.attr('action'),
					type: 'POST',
					dataType: 'json',
					data: data_post,
				})
				.done(function (res) {
					...
					if (res.success) {
						var id = $('#kecamatan_image_galery').find('li').attr('qq-file-id');
						if (save_type == 'back') {
