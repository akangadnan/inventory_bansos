				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group group-kecamatan-id">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select-deselect" name="kecamatan_id"
									...
									<option <?= $row->kecamatan_id == $kelurahan->kecamatan_id ? 'selected' : ''; ?>
						...
						<div class="form-group group-kelurahan-nama  ">
							<label for="kelurahan_nama" class="col-sm-2 control-label">Nama Kelurahan <i
									class="required">*</i>
							</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="kelurahan_nama" id="kelurahan_nama"
									placeholder=""
									value="<?= set_value('kelurahan_nama', $kelurahan->kelurahan_nama); ?>">
								<small class="info help-block">
