...
<script type="text/javascript">
	...
	function domo() {
		...
		$('*').bind('keydown', 'Ctrl+a', function assets() {
			window.location.href = BASE_URL + '/administrator/Posko/add';
			return false;
		});
...
<section class="content-header">
	<h1>
		<?= cclang('posko') ?><small><?= cclang('list_all'); ?></small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active"><?= cclang('posko') ?></li>
	</ol>
</section>
<!-- Main content -->
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="widget-user-header ">
							<div class="row pull-right">
								<?php is_allowed('posko_add', function(){?>
								<a class="btn btn-flat btn-success btn_add_new" id="btn_add_new"
									title="<?= cclang('add_new_button', [cclang('posko')]); ?>  (Ctrl+a)"
									href="<?=  site_url('administrator/posko/add'); ?>"><i
										class="fa fa-plus-square-o"></i>
									<?= cclang('add_new_button', [cclang('posko')]); ?></a>
								<?php }) ?>
								<?php is_allowed('posko_export', function(){?>
								<a class="btn btn-flat btn-success"
									title="<?= cclang('export'); ?> <?= cclang('posko') ?> "
									href="<?= site_url('administrator/posko/export?q='.$this->input->get('q').'&f='.$this->input->get('f')); ?>"><i
								...
								<div class="col-md-8">
									...
									<div class="col-sm-1 padd-left-0 ">
										<a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply"
											href="<?= base_url('administrator/posko');?>"
...
<script>
	$(document).ready(function () {
		...
		initSortable('posko', $('table.dataTable'));
	}); /*end doc ready*/
</script>