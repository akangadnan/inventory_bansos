...
<section class="content-header">
	<h1>
		Retur Barang <small><?= cclang('new', ['Retur Barang']); ?> </small>
	</h1>
	<ol class="breadcrumb">
				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="widget-user-header ">
							...
							<h5 class="widget-user-desc"><?= cclang('new', ['Retur Barang']); ?></h5>
							<hr>
						</div>
						<?= form_open('', [
						'name' => 'form_retur',
						...
						<div class="form-group group-keterangan ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="keterangan" id="keterangan"
									placeholder="Keterangan" value="<?= set_value('keterangan'); ?>">
								<small class="info help-block">
								</small>
							</div>
						</div>
...
<script>
	$(document).ready(function () {
		...
		$('.btn_save').click(function () {
			...
			$.ajax({
					url: BASE_URL + '/administrator/retur/add_save',
					type: 'POST',
					dataType: 'json',
					data: data_post,
				})
		...
		function chained_barang(complete) {
			$.LoadingOverlay('show')
			$.ajax({
				url: BASE_URL + '/administrator/retur/ajax_barang/',
				dataType: 'JSON',
			})
			.done(function (res) {
