				...
				<div class="box-body ">
					...
					'method'  => 'POST'
						...
						<div class="form-group ">
							<label for="username" class="col-sm-2 control-label"><?= cclang('username') ?> <i
						...
						<div class="form-group ">
							<label for="email" class="col-sm-2 control-label"><?= cclang('email') ?> <i
									class="required">*</i></label>
						...
						<div class="form-group ">
							<label for="user_panggilan" class="col-sm-2 control-label"><?= cclang('nick_name') ?> <i
									class="required">*</i></label>

							<div class="col-sm-8">
								<input type="text" class="form-control" name="user_panggilan" id="user_panggilan"
									placeholder="Full Name" value="<?= set_value('user_panggilan'); ?>">
								<small class="info help-block">The full name of user.</small>
							</div>
						</div>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select" name="posko_id" id="posko_id" placeholder="Select Posko">
									...
									<option value="<?= $row->posko_id; ?>"><?= ucwords($row->posko_nama); ?></option>
									<?php endforeach; ?>
								</select>
						...
						<div class="form-group ">
							<label for="content" class="col-sm-2 control-label"><?= cclang('groups') ?> <i
									class="required">*</i></label>
						...
						<div class="row-fluid col-md-7">
							<button class="btn btn-flat btn-primary btn_save btn_action" id="btn_save" data-stype='stay'
								title="save (Ctrl+s)"><i class="fa fa-save"></i> <?= cclang('save_button'); ?></button>
